...
See detailed [technical specifications](specs.md#electrical-parameters) for complete electrical and mechanical parameters.
...
For installation and setup instructions, see our [setup guide](setup.md#installation).
...
4. Configure via [UART interface](setup.md#uart-configuration)
...
- 💡 [Example Projects](examples.md#basic-setup)